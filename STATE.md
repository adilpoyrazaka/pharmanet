...
- `decisions.md` — 28 kilitli karar, gerekçeleriyle.
...
- **Ana ekran tasarımı** → A1 (kapsama oranı) sonucunu bekliyor.
  Oran düşükse ürün *filtre*, yüksekse *doğrulama aracı*. İkisi farklı ekran.
- **Reklam eşiği** → 30 günlük geri dönen ziyaretçi verisi olmadan belirlenemez.

## Açık kararlar
- **A1** Kapsama oranı — Gemini G-2 bekleniyor
- **A2** Reklam eşiği sayısı — trafik verisi bekleniyor
- **A3** (kapandı — 8 maddelik liste işlendi)
